...
func (dc *DatabaseController) GetCustomDatabaseSchema(c *gin.Context) {
	...
	dbConn, dbTypesBytes, err := dc.connectionService.GetConnection(userUUID, dbUUID)
	if err != nil {
...
func (dc *DatabaseController) GetFullCustomDatabaseSchema(c *gin.Context) {
	...
	dbConn, dbTypes, err := dc.connectionService.GetConnection(userUUID, dbUUID)
	if err != nil {
